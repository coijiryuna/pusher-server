...
```bash
export NINEROUTER_URL="https://9router.rifacomputer.my.id/v1"      # or VPS / tunnel URL
export NINEROUTER_KEY="sk-f4901669dbc6759b-y6darw-d49655a0"        # from Dashboard → Keys (only if requireApiKey=true)
```
